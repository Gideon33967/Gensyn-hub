...
import { Activity, Cpu, Users, Zap, TrendingUp, Award, Calculator, Rocket } from 'lucide-react';
...
const GensynHub = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-900 via-stone-800 to-amber-900 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button className="px-6 py-3 bg-pink-300 text-stone-900 font-bold hover:bg-pink-400 transition-all transform hover:scale-105 border-2 border-stone-900">
                JOIN THE SWARM
              </button>
            </div>
          </div>
      ...
      <nav className="relative z-10 bg-stone-800/50 backdrop-blur border-b-2 border-pink-300/30">
        ...
        {activeTab === 'dashboard' && (
          <div className="space-y-8">
            <div className="text-center mb-12">
              <h2 className="text-6xl font-bold mb-4" style={{ fontFamily: 'monospace' }}>
                DECENTRALIZED ML COMPUTE
              </h2>
              <p className="text-2xl text-pink-200">Powering the Future of AI Training</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-stone-800/80 border-4 border-pink-300 p-6 transform hover:scale-105 transition-all">
                ...
                <div className="text-5xl font-bold mb-2">{nodes}</div>
              ...
              <div className="bg-stone-800/80 border-4 border-pink-300 p-6 transform hover:scale-105 transition-all">
                ...
                <div className="text-5xl font-bold mb-2">{computePower} PF</div>
              ...
              <div className="bg-stone-800/80 border-4 border-pink-300 p-6 transform hover:scale-105 transition-all">
                ...
                <div className="text-5xl font-bold mb-2">{activeUsers}</div>
                <div className="text-pink-200 uppercase tracking-wide">Active Users</div>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
              <div className="bg-gradient-to-br from-pink-300 to-pink-400 p-8 border-4 border-stone-900 text-stone-900">
                <Rocket className="w-12 h-12 mb-4" />
                <h3 className="text-3xl font-bold mb-2">Start Computing</h3>
              ...
              <div className="bg-stone-800/80 border-4 border-pink-300 p-8">
                ...
                <h3 className="text-3xl font-bold mb-2">Run a Node</h3>
        ...
        {activeTab === 'leaderboard' && (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-pink-200">Community Leaders of the Swarm</p>
            </div>

            <div className="bg-stone-800/80 border-4 border-pink-300 overflow-hidden">
              <div className="bg-pink-300 px-6 py-4 grid grid-cols-4 gap-4 font-bold text-stone-900 uppercase tracking-wide border-b-4 border-stone-900">
                <div>Rank</div>
                <div>Contributor</div>
                <div>GPU Hours</div>
                <div>Badge</div>
              ...
              {leaderboardData.map((user, idx) => (
                <div 
                  key={user.rank}
                  className={`px-6 py-6 grid grid-cols-4 gap-4 items-center border-b-2 border-pink-300/20 hover:bg-stone-700/50 transition-all ${
                    idx === 0 ? 'bg-yellow-900/20' : ''
                  }`}
                >
                  <div className="text-3xl font-bold text-pink-300">{user.rank}</div>
                  <div className="font-mono text-lg">{user.name}</div>
            ...
            <div className="text-center mt-8">
              <button className="px-8 py-4 bg-pink-300 text-stone-900 font-bold text-xl hover:bg-pink-400 transition-all transform hover:scale-105">
        ...
        {activeTab === 'models' && (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-pink-200">AI Models Trained on Gensyn</p>
            </div>
